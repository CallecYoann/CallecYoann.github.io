...
while( $ligne = $stmt->fetch() ) // boucle sur chaque enregistrement
{
		...
		echo '<td class="petit"><a class="btn btn-warning btn-sm" href=function/edit.php?id=' . $ligne['id']  . '>edit</a></td>';
...
<!-- DEBUT FENETRE MODAL BOUTON EDIT -->
  <div class="container">
  <!-- Modal -->
  <div class="modal fade" id="addBtnEditModal" role="dialog">
    <div class="modal-dialog">
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>         <!-- BOUTON CLOSE MODAL -->
          <h4 class="modal-title">Edit track</h4>    <!--  HEADER MODAL -->
        </div>
        <div class="modal-body">    <!-- BODY MODAL-->
